...
# Contributing to Figurative

Firstly, thank you for taking an interesting in contributing! Figurative is an
...
have commit rights to the `propensive/figurative` repository, push to a branch named
...
in extreme cases. Figurative does not use automatic code-formatting because it
...
Figurative&rsquo;s users. Propensive O&Uuml; reserves the right to censure
